      ...
      <footer className="border-t border-white/10 bg-slate-900/80 py-12 backdrop-blur-lg">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 text-center border-t border-white/10 pt-6">
            <a 
              href="/admin" 
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-slate-700 to-slate-800 hover:from-slate-600 hover:to-slate-700 text-white font-bold rounded-lg transition-all hover:scale-105 shadow-lg"
            >
            ...
            <p className="text-xs text-slate-500 mt-2">Gestiona reseñas, redes sociales y contenido</p>
          </div>
        </div>
      </footer>
